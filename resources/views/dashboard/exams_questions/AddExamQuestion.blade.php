                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('exam_questions.index') }}" class="btn btn-success pull-right">all
                                    exam_questions</a>
                    ...
                    <div class="panel-body">
                        ...
                        @if (isset($exam) && isset($question))

                            <form class="form-horizontal" action="{{ route('exam_questions.update',['exam'=>$exam->id,'question'=>$question->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="submit" value="Edit Exam Question" class="btn btn-success">
                                    </div>
                                </div><!-- form-group -->
                            </form>
                        @else
